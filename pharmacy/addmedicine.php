	 ...
	 ?>
		<div class="right"><br>
			...
			<center>
				...
				<input type="text" name="name" class="form" placeholder="Enter Medicine Name" required><br><br>
				<input type="number" name="price" class="form" placeholder="Enter Medicine Price" required><br><br>
